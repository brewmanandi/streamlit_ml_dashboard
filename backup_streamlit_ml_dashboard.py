...
## Dashboard
st.title("Experiment with Random Forest :bar_chart:")
st.markdown("Select parameters of random forest classifier and click on submit. It'll train classifier on news groups dataset (scikit-learn) and evaluate various ML metrics. Dataset has various news articles on topics like **{}**".format(categories))
